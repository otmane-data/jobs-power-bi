...
# Header
st.markdown('<div class="main-header">🎯 Job Recommender IA</div>', unsafe_allow_html=True)
st.markdown('<div class="sub-header">Système de recommandation intelligent pour les métiers de la Data</div>', unsafe_allow_html=True)
...
if search_button:
    ...
    if search_mode == "📝 Saisie Manuelle" and not profile_text and not keywords_list:
        st.warning("⚠️ Veuillez saisir un profil ou des compétences")
        st.stop()
...
<div style="text-align: center; color: #888; padding: 1rem;">
    <p>🎯 Job Recommender IA - Système de recommandation intelligent pour les métiers de la Data</p>
