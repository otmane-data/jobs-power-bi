"""
API FastAPI pour le système de recommandation d'offres d'emploi
"""
...
from config import API_HOST, API_PORT, DEFAULT_TOP_K, MAX_TOP_K
...
if __name__ == "__main__":
    ...
    print(f"Documentation interactive: http://localhost:{API_PORT}/docs")
    print("="*80 + "\n")
